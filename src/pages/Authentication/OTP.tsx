...
export default function Otp(){
    return(
        ...
        <Link to={'signup'}><a className="py-2 px-3 bg-transparent font-semibold text-black hover:text-white hover:bg-black border border-black hover:border-transparent rounded-full font-montserrat">Sign Up</a></Link>
        </header>
        <section>
