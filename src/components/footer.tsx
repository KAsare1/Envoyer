...
<footer className="bg-[#8E2C2C] m-4">
    <div className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
      <span className="text-sm text-gray-100 sm:text-center dark:text-gray-100">© 2024 <a href="#" className="hover:underline">Cloudsoft Technologies</a>. All Rights Reserved.
    </span>
    <ul className="flex flex-wrap items-center mt-3 text-m font-medium text-gray-100 sm:mt-0">
    <li>
            <a href="#" className="hover:underline me-4 md:me-6">Company</a>
        </li>
        <li>
    ...
    <div className="px-4 py-6 bg-gray md:flex md:items-center md:justify-center">
        ...
        <div className="flex mt-4 sm:justify-center md:mt-0 space-x-5 rtl:space-x-reverse">
            <a href="#" className="text-gray-100 hover:text-gray-900 dark:hover:text-white">
              ...
              <a href="#" className="text-gray-100 hover:text-gray-100 dark:hover:text-white">
              ...
              <a href="#" className="text-gray-100 dark:hover:text-white">
                  <svg className="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
